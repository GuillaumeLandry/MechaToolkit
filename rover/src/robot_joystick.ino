...
void loop() {
  ...
  if (joyposVert < 460)
  {
    ...
    if (joyposHorz > 600) digitalWrite(in2, LOW);
    else if (joyposHorz < 400) digitalWrite(in4, LOW);
  ...
  else if (joyposVert > 564)
  {
    ...
    if (joyposHorz < 400) digitalWrite(in3, LOW);
    else if (joyposHorz > 600) digitalWrite(in1, LOW);
  ...
  Serial.print("Vertical: " + String(joyposVert) + " | Horizontal: " + String(joyposHorz) + "\n");
  Serial.print("MotorSpeed1: " + String(MotorSpeed1) + " | MotorSpeed2: " + String(MotorSpeed2) + "\n\n");
